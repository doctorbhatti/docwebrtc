 ...
 * @create date 2021-03-15 01:16:40
 * @modify date 2021-03-15 01:16:43
 * @desc [description]
 */
...
export default {
  ...
  getQString (url = '', keyToReturn = '') {
    ...
    if (queryStrings) {
      const splittedQStrings = queryStrings.split('&')

      if (splittedQStrings.length) {
        const queryStringObj = {}

        splittedQStrings.forEach(function (keyValuePair) {
          const keyValue = keyValuePair.split('=', 2)
  ...
  addChat (data, senderType) {
    ...
    colDiv.className = 'col-10 card chat-card'
