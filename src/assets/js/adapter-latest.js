 ...
 * @create date 2021-03-15 01:16:02
 * @modify date 2021-03-15 01:16:03
 * @desc [description]
 */
  ...
  })()(
    {
      1: [
        function (require, module, exports) {
          ...
          const adapter = (0, _adapter_factory.adapterFactory)({ window: typeof window === 'undefined' ? undefined : window })
        ...
        function (require, module, exports) {
          ...
          function shimGetSendersWithDtmf (window) {
            ...
            if (
              ...
              window.RTCPeerConnection.prototype.removeStream = function removeStream (stream) {
                ...
                stream.getTracks().forEach(function (track) {
                  const sender = _this3._senders.find(function (s) {
          ...
          function shimAddTrackRemoveTrackWithNative (window) {
            ...
            window.RTCPeerConnection.prototype.addStream = function addStream (stream) {
              ...
              stream.getTracks().forEach(function (track) {
                const alreadyExists = _this9.getSenders().find(function (s) {
                  return s.track === track
                })
                if (alreadyExists) {
              ...
              const newSenders = this.getSenders().filter(function (newSender) {
          ...
          function shimAddTrackRemoveTrack (window, browserDetails) {
            ...
            window.RTCPeerConnection.prototype.addStream = function addStream (stream) {
              ...
              stream.getTracks().forEach(function (track) {
                const alreadyExists = _this12.getSenders().find(function (s) {
                  return s.track === track
                })
                if (alreadyExists) {
                  throw new DOMException('Track already exists.', 'InvalidAccessError')
            ...
            window.RTCPeerConnection.prototype.addTrack = function addTrack (track, stream) {
              ...
              const alreadyExists = this.getSenders().find(function (s) {
                return s.track === track
              })
              if (alreadyExists) {
                throw new DOMException('Track already exists.', 'InvalidAccessError')
            ...
            window.RTCPeerConnection.prototype.removeTrack = function removeTrack (sender) {
              ...
              Object.keys(this._streams).forEach(function (streamid) {
                const hasTrack = _this15._streams[streamid].getTracks().find(function (track) {
        ...
        function (require, module, exports) {
          ...
          function shimAddIceCandidateNullOrEmpty (window, browserDetails) {
            ...
            window.RTCPeerConnection.prototype.addIceCandidate = function addIceCandidate () {
              ...
              if (
                ((browserDetails.browser === 'chrome' && browserDetails.version < 78) || (browserDetails.browser === 'firefox' && browserDetails.version < 68) || browserDetails.browser === 'safari') &&
                arguments[0] &&
          ...
          function shimCreateOfferLegacy (window) {
            ...
            window.RTCPeerConnection.prototype.createOffer = function createOffer (offerOptions) {
              if (offerOptions) {
                ...
                const audioTransceiver = this.getTransceivers().find(function (transceiver) {
                ...
                const videoTransceiver = this.getTransceivers().find(function (transceiver) {
      ...
      16: [
        function (require, module, exports) {
          ...
          function filterIceServers (iceServers, edgeVersion) {
            ...
            return iceServers.filter(function (server) {
              if (server && (server.urls || server.url)) {
                ...
                urls = urls.filter(function (url) {
                  const validTurn = url.indexOf('turn:') === 0 && url.indexOf('transport=udp') !== -1 && url.indexOf('turn:[') === -1 && !hasTurn
          ...
          function maybeAddCandidate (iceTransport, candidate) {
            ...
            const alreadyAdded = iceTransport.getRemoteCandidates().find(function (remoteCandidate) {
              return (
          ...
          module.exports = function (window, edgeVersion) {
            ...
            RTCPeerConnection.prototype._gather = function (mid, sdpMLineIndex) {
              ...
              const bufferedCandidateEvents = this.transceivers[sdpMLineIndex].bufferedCandidateEvents
            ...
            RTCPeerConnection.prototype._transceive = function (transceiver, send, recv) {
              const params = getCommonCapabilities(transceiver.localCapabilities, transceiver.remoteCapabilities)
            ...
            RTCPeerConnection.prototype.setLocalDescription = function (description) {
              ...
              if (description.type === 'offer') {
                ...
                sections.forEach(function (mediaSection, sdpMLineIndex) {
                  ...
                  const rejected = SDPUtils.isRejected(mediaSection) && SDPUtils.matchPrefix(mediaSection, 'a=bundle-only').length === 0
                  ...
                  if (!rejected && !transceiver.rejected) {
                    ...
                    const params = getCommonCapabilities(localCapabilities, remoteCapabilities)
            ...
            RTCPeerConnection.prototype.setRemoteDescription = function (description) {
              ...
              sections.forEach(function (mediaSection, sdpMLineIndex) {
                ...
                if (description.type === 'offer' && !rejected) {
                  ...
                  const commonCapabilities = getCommonCapabilities(transceiver.localCapabilities, transceiver.remoteCapabilities)
      ...
      */
            ...
            RTCPeerConnection.prototype.createOffer = function () {
              ...
              pc.transceivers.forEach(function (transceiver, sdpMLineIndex) {
                ...
                localCapabilities.headerExtensions.forEach(function (hdrExt) {
                  const remoteExtensions = (transceiver.remoteCapabilities && transceiver.remoteCapabilities.headerExtensions) || []
              ...
              return new Promise(function (resolve, reject) {
                if (!pc._remoteDescription) {
                  ...
                  if (transceiver) {
                    ...
                    const cand = Object.keys(candidate.candidate).length > 0 ? SDPUtils.parseCandidate(candidate.candidate) : {}
            ...
            const ortcObjects = ['RTCRtpSender', 'RTCRtpReceiver', 'RTCIceGatherer', 'RTCIceTransport', 'RTCDtlsTransport']
      ...
      17: [
        function (require, module, exports) {
          ...
          SDPUtils.parseRtpEncodingParameters = function (mediaSection) {
            ...
            const flows = SDPUtils.matchPrefix(mediaSection, 'a=ssrc-group:FID').map(function (line) {
