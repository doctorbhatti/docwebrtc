 ...
 * @create date 2021-03-15 01:17:02
 * @modify date 2021-03-15 20:45:12
 * @desc [description]
 */
...
window.addEventListener('load', () => {
  ...
  if (!room) {
    ...
    const fabElem = document.getElementById('mainFab')
    const roomDev = document.getElementById('roomFab')

    for (let i = 0; i < commElem.length; i++) {
      commElem[i].attributes.removeNamedItem('hidden')
    }
    fabElem.style.visibility = "hidden";
    fabElem.style.width = 0;
    fabElem.style.height = 0;
    roomDev.style.visibility = "visible";
    ...
    function init (createOffer, partnerName) {
      ...
      pc[partnerName].ontrack = (e) => {
        ...
        if (document.getElementById(`${partnerName}-video`)) {
          ...
          const intro = document.getElementById('roomIntro')
