 ...
 * @create date 2021-03-15 01:16:33
 * @modify date 2021-03-15 01:16:34
 * @desc [description]
 */
...
window.addEventListener('load', () => {
  ...
  document.getElementById('create-room').addEventListener('click', (e) => {
    ...
    if (roomName && yourName) {
      ...
      // create room link
      const roomLink = `${location.origin}?room=${roomName.trim().replace(' ', '_')}_${helpers.generateRandomString()}`
